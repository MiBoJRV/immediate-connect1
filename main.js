 ...
 */
            function (e) {
                var t, n, r, i, o, a, u, s, l, c, f, d, p, h, m, g, v, y, b, x = "sizzle" + 1 * new Date,
                    ...
                    V = new RegExp(H + "|>"), Y = new RegExp(M), U = new RegExp("^" + R + "$"), X = {
                        ID: new RegExp("^#(" + R + ")"),
                        CLASS: new RegExp("^\\.(" + R + ")"),
                        TAG: new RegExp("^(" + R + "|[*])"),
                        ATTR: new RegExp("^" + I),
                ...
                for (t in n = ue.support = {}, o = ue.isXML = function (e) {
                    ...
                    pseudos: {
                        not: le((function (e) {
                            ...
                            return U.test(e || "") || ue.error("unsupported lang: " + e), e = e.replace(te, ne).toLowerCase(), function (t) {
                                var n;
                                do {
        ...
        function Ue(e, t, n) {
            ...
            return (n = n || Ve(e)) && ("" !== (a = n.getPropertyValue(t) || n[t]) || ue(e) || (a = C.style(e, t)), !v.pixelBoxStyles() && _e.test(a) && Ye.test(t) && (r = u.width, i = u.minWidth, o = u.maxWidth, u.minWidth = u.maxWidth = u.width = a, a = n.width, u.width = r, u.minWidth = i, u.maxWidth = o)), void 0 !== a ? a + "" : a
        }
        ...
        function ot(e, t, n) {
            var r = Ve(e), i = (!v.boxSizingReliable() || n) && "border-box" === C.css(e, "boxSizing", !1, r), o = i,
                a = Ue(e, t, r), u = "offset" + t[0].toUpperCase() + t.slice(1);
            if (_e.test(a)) {
                if (!n) return a;
                a = "auto"
            }
        ...
        C.extend({
            ...
            css: function (e, t, n, r) {
                var i, o, a, u = G(t);
                return et.test(t) || (t = Ke(u)), (a = C.cssHooks[t] || C.cssHooks[u]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ue(e, t, r)), "normal" === i && t in nt && (i = nt[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
            }
        ...
        v.cors = !!Xt && "withCredentials" in Xt, v.ajax = Xt = !!Xt, C.ajaxTransport((function (e) {
            ...
            if (v.cors || Xt && !e.crossDomain) return {
                send: function (i, o) {
                    ...
                    t = function (e) {
                        return function () {
                            t && (t = r = u.onload = u.onerror = u.onabort = u.ontimeout = u.onreadystatechange = null, "abort" === e ? u.abort() : "error" === e ? "number" != typeof u.status ? o(0, "error") : o(u.status, u.statusText) : o(Ut[u.status] || u.status, u.statusText, "text" !== (u.responseType || "text") || "string" != typeof u.responseText ? {binary: u.response} : {text: u.responseText}, u.getAllResponseHeaders()))
                        }
        ...
        C.ajaxSetup({
            ...
            C.cssHooks[t] = Xe(v.pixelPosition, (function (e, n) {
                if (n) return n = Ue(e, t), _e.test(n) ? C(e).position()[t] + "px" : n
            }))
    ...
    var o = function () {
        function e(t, n) {
            ...
            }(this, e), !t) throw "Invalid form param";
            n && (Object.keys(n).forEach((function (e) {
                if (!t.querySelector('input[name="'.concat(e, '"]'))) throw "".concat(e, " is not a valid input in the form.")
            })), this.rules = n);
            this.form = t, this.validationResults = {}, this.validationMsgsConfig = i, this.validationStatus = !0, document.addEventListener("registrationError", (function (e) {
    ...
    (function (e) {
        "us" == e("meta[name=isoCode]").attr("content") && e("body").addClass("modal-open").append('<div class="modalDialog-white open" style="pointer-events: auto;"><div class="container"><div class="modal-country">Forbidden - Visitors from your country are not permitted to browse this site.</div></div></div>')
    }).call(this, n(0))
}, function (e, t, n) {
    "use strict";
    (function (e) {
        ...
        function s(e) {
            ...
            if ("cz" == t) switch (e) {
                case"There was an error processing your request, please try again later.":
                    e = "Při zpracování vašeho požadavku došlo k chybě, zkuste to prosím znovu později.";
                    break;
                case"You are already registered in our system.":
                    e = "Jste již zaregistrováni v našem systému.";
                    break;
                case"It seems like you didn't enter a valid phone number. Please enter your phone number in order to get exclusive help from one of our specialists!":
                    e = "Zdá se, že jste nezadali platné telefonní číslo. Zadejte prosím své telefonní číslo, abyste získali exkluzivní pomoc.";
                    break;
                case"The phone field is required.":
                    e = "Prosím zadejte své skutečné telefonní číslo."
            }
            if ("fi" == t) switch (e) {
                case"There was an error processing your request, please try again later.":
                    e = "Pyyntösi käsittelyssä tapahtui virhe, yritä myöhemmin uudelleen.";
                    break;
                case"You are already registered in our system.":
                    e = "Olet jo rekisteröitynyt järjestelmäämme.";
                    break;
                case"It seems like you didn't enter a valid phone number. Please enter your phone number in order to get exclusive help from one of our specialists!":
                    e = "Vaikuttaa siltä, että et antanut kelvollista puhelinnumeroa. Kirjoita puhelinnumerosi saadaksesi apua.";
                    break;
                case"The phone field is required.":
                    e = "Anna oikea puhelinnumerosi"
            }
            if ("in" == t) switch (e) {
                case"There was an error processing your request, please try again later.":
            ...
            if ("jp" == t) switch (e) {
                case"There was an error processing your request, please try again later.":
                    e = "リクエストの処理中にエラーが発生しました。しばらくしてからもう一度お試しください。";
                    break;
                case"You are already registered in our system.":
                    e = "お客様は既に登録されています。";
                    break;
                case"It seems like you didn't enter a valid phone number. Please enter your phone number in order to get exclusive help from one of our specialists!":
                    e = "無効な電話番号です。専属のサポートを受けるには、お手数ですが、電話番号をご入力ください。";
                    break;
                case"The phone field is required.":
                    e = "ご利用中の電話番号を入力してください。"
            }
            if ("lt" == t) switch (e) {
                case"There was an error processing your request, please try again later.":
                    ...
                    break;
                case"You are already registered in our system.":
                    e = "Jūs jau esate registruotas mūsų sistemoje.";
                    break;
                case"It seems like you didn't enter a valid phone number. Please enter your phone number in order to get exclusive help from one of our specialists!":
                    e = "Atrodo, kad neįvedėte teisingo telefono numerio. Įveskite savo telefono numerį, kad gautumėte išskirtinę pagalbą.";
                    break;
                case"The phone field is required.":
                    e = "Įveskite savo tikrąjį telefono numerį"
            }
            return e
        }
        ...
        o.forEach((function (e, t) {
            ...
            var r = document.head.querySelector("[name~=isoCode][content]").content;
            n.preventDefault();
            var i = e(this), o = e(this).attr("data-lang") ? "/" + e(this).attr("data-lang") : "",
                u = e(this).serializeArray();
            if (t = e(this).attr("data-lang"), i.find(".alert").text("").addClass("hidden"), i.find("[name=agree]").length && !i.find("[name=agree]").is(":checked")) return e("#openModalLoading").addClass("open"), setTimeout((function () {
                e("#openModalLoading").removeClass("open"), i.find(".alert").text("").removeClass("hidden"), i.find(".alert").append(s("Please agree to the terms of service.") + "<br />")
            }), 1200), !1;
            var l = e('[data-id="form"]').toArray().indexOf(this);
            a[l].validate(), a[l].updateValidationState(), a[l].updateValidationStatus(), a[l].validationStatus && (e("#openModalLoading").addClass("open"), window.location.href.indexOf("stest") > -1 && u.push({
                name: "stest",
                value: !0
            }), u.push({name: "lang", value: e(this).attr("data-lang")}, {
                name: "isoCode",
                value: r
            }), e.ajax({
                url: "/api9/", type: "POST", data: u, success: function (t) {
                    e.redirect(o + "/thankyou/", {link: JSON.parse(t).extras.redirect.url})
                }, error: function (t) {
                    setTimeout((function () {
                        e("#openModalLoading").removeClass("open"), i.find(".alert").text("").removeClass("hidden"), e.each(JSON.parse(t.responseText).errors, (function (e, t) {
                            i.find(".alert").append(s(t) + "<br />")
                        }))
                    }), 1200)
                }
            }))
